...
const ProfileFormTransaction = () => {
  ...
  const fetchTransactionIds = async (userEmail) => {
    try {
      const transactionSnapshot = await getDocs(collection(projectExtensionFirestore, 'accounts', userEmail, 'transactions'));
        ...
        {profileData && (
          <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <View style={{ flexDirection: screenWidth < 993 ? 'column' : 'row' }}>
              <View style={{ flex: screenWidth < 993 ? 0 : 2, marginBottom: screenWidth < 993 ? 20 : 0 }}>
                {/* First view content */}
              ...
              <View style={{ flex: screenWidth < 993 ? 0 : 3, padding: 5 }}>
                {/* Middle view content */}
                ...
                <View style={{ flexDirection: screenWidth < 335 ? 'column' : 'row', marginBottom: 10 }}>
                  <View style={{ flex: 1, alignItems: screenWidth < 335 ? 'center' : 'flex-start' }}>
                    ...
                    <View style={{ alignSelf: screenWidth < 335 ? 'flex-start' : 0 }}>
                      <Text style={{ color: '#aaa', fontSize: 12 }}>Mozambique, Dar Es Salaam</Text>
                    </View>
                  </View>
                  <View style={{ flex: screenWidth < 335 ? 0 : 1, alignItems: screenWidth < 335 ? 'center' : 'flex-end' }}>
                    <View>
              ...
              <View style={{ flex: 1, alignItems: screenWidth < 993 ? <></> : 'center', justifyContent: 'center' }}>
